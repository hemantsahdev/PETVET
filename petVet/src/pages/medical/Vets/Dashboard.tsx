            ...
            <div className="w-full h-full px-16 py-4 flex flex-row items-center gap-12 ">
              ...
              <div className="flex flex-col h-full w-1/2 items-start justify-center gap-4">
                <h1 className="text-5xl font-bold ">
                  Hello , <span className="capitalize">{vetDetails.name} </span>
                </h1>
                <h2 className="text-xl font-medium italic text-gray-700">
                  Your expertise is like a magic wand for pets! Hundreds are
                  eagerly waiting for your special touch in{" "}
                  <span>{vetDetails.speciality} </span>.
                </h2>
              </div>
          ...
          <section className="w-full h-2/3 flex flex-row  bg-white">
            <div className="w-1/2 h-full flex flex-col">
              <div className="h-1/2 w-full flex flex-row justify-evenly items-center">
                ...
                >
                  <h3 className="text-2xl font-bold">Appointments Today</h3>
                ...
                >
                  <h3 className="text-2xl font-bold">Active Bookings</h3>
              ...
              <div className="h-1/2 w-full flex flex-row justify-evenly items-center">
                ...
                >
                  <h3 className="text-2xl font-bold">Available Slots</h3>
                ...
                >
                  ...
                  <h4 className="text-3xl font-bold">43</h4>
                </div>
              </div>
            </div>
